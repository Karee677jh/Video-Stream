...
from pytgcalls import (__version__from datetime import datetime
from sys import version_info
from time import time
...
python_version = f"{version_info[0]}.{version_info[1]}.{version_info2]}"
...
💭 [{BOT_NAME} يتيح لك تشغيل الموسيقى والفيديو في مجموعات من خلال محادثات الفيديو الجديدة في Telegram!
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton("💭 البشمبرمج", url=f"https://t.me/EM_96")
                        ],
                        [
